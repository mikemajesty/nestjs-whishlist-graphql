    ...
    404: Swagger.defaultResponseWithMultiplesError({
      ...
      messages: {
        'wishlist not found': {
          ...
          value: [`wishlist from user: [userName] not found.`],
        },
        'product not found': {
          description: "when product does't exists on wishlist",
          value: [`product: [productName] does't exists on wishlist.`],
        },
      },
      description: 'product exists.',
    }),
  ...
  delete: {
    ...
    404: Swagger.defaultResponseWithMultiplesError({
      ...
      messages: {
        ...
        'product not found': {
          description: "when product doesn't exists on wishlist.",
          value: [`product: [productname] does't exists on wishlist.`],
        },
      },
      description: 'product exists.',
