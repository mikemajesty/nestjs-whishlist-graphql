...
export const WishlistProductExistsInputSchema = WishlistEntitySchema.pick({
  user: true,
}).merge(
...
export type WishlistProductExistsInput = z.infer<
  typeof WishlistProductExistsInputSchema
>;
